...
public class Auditoria implements Serializable {
	...
	public enum ACCION {
		LOGIN, LOGOUT, OA_CREAR, OA_EDITAR, OA_ELIMINAR, TM_CREAR, TM_EDITAR, TM_ELIMINAR, ACTIVIDAD_CREAR, ACTIVIDAD_EDITAR, ACTIVIDAD_ELIMINAR, ASOCIACION_GUARDAR, ASOCIACION_ELIMINAR
	}
