...
public interface ObjetivoAprendizajeRepository extends JpaRepository<ObjetivoAprendizaje, Long> {
	...
	@Query(value="select oa from ObjetivoAprendizaje oa "
				+ "join oa.hijos h "
...
// https://stackoverflow.com/questions/24750754/org-hibernate-queryexception-illegal-attempt-to-dereference-collection
